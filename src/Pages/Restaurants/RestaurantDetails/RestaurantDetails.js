...
const RestaurantDetails = () => {
    return (
        <div>
            <section className="hero_in restaurants_detail">
                <div className="wrapper">
                    <div className="container">
                        <h1 className="fadeInUp"><span></span>Restaurant detail page</h1>
                    </div>
                    <span className="magnific-gallery">
                        <Link to="img/gallery/restaurant_list_1.jpg" className="btn_photos text-decoration-none" title="Photo title" data-effect="mfp-zoom-in">View photos</Link>
                        <Link to="img/gallery/restaurant_list_2.jpg" title="Photo title" data-effect="mfp-zoom-in"></Link>
                        <Link to="img/gallery/restaurant_list_3.jpg" title="Photo title" data-effect="mfp-zoom-in"></Link>
                    </span>
                </div>
            </section>
                    ...
                    <div className="row">
                        ...
                        <aside className="col-lg-4" id="sidebar">
                            <div className="box_detail booking">
                                ...
                                <div className="form-group input-dates scroll-fix">
                                ...
                                <Link to="cart-1.html" className=" add_top_30 btn_1 full-width purchase">Book now</Link>
                            ...
                            <ul className="share-buttons">
                                <li><Link className="fb-share text-decoration-none" to="#0"><i className="social_facebook"></i> Share</Link></li>
                                <li><Link className="twitter-share text-decoration-none" to="#0"><i className="social_twitter"></i> Tweet</Link></li>
                                <li><Link className="gplus-share text-decoration-none" to="#0"><i className="social_googleplus"></i> Share</Link></li>
                            </ul>
                        </aside>
                    </div>
                </div>
